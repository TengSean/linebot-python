...
def crawler(ticker, sd, ed):
	...
	ticker: str
		股票代碼
	sd, ed : str
		開始日期與結束日期（eg. 2020-03-01, 2020-04-01）
...
def getApproxDate(ticker, start, end):
	...
	ticker : str
		股票代碼
	start, end : str
		開始以及結束日期 （ eg: 2020-03-01, 2020-04-01 ）
	'''
...
#             print(trade_date_list[i])
	...
	''' 
	# print(open_indices, close_indices)
...
# In[27]:
# NOTE this is NOTE demo
# TAG Tag
# DONE This is DONE DEMO.
# WARNING This is warning demo.
# FIXME This is FIXME demo.
# TODO this is TODO DEMO.
